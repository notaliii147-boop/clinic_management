// reptile.js - Interactive Reptile Cursor
var Input = {
    keys: [],
    mouse: {
        left: false,
...
class Creature {
    ...
    draw(iter) {
        ...
        ctx.lineTo(this.x + r * Math.cos(this.absAngle) * 2 ** 0.5,
...
// Theme management for reptile
function updateReptileTheme() {
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initReptile);
} else {
    initReptile();
}